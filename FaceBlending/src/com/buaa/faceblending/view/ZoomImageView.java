...
public class ZoomImageView extends View implements Observer {
	...
	public Bitmap getImage(){
		Bitmap resultBitmap = Bitmap.createBitmap(mBitmap, mRectSrc.left, mRectSrc.top, mRectDst.right-mRectDst.left, mRectDst.top-mRectDst.bottom);
		return resultBitmap;
	}
	...
	protected void onDraw(Canvas canvas) {
		if (mBitmap != null && mState != null) {
			...
			Log.i("width", "Zoom view width"+viewWidth);
